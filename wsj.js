 url = `https://newsapi.org/v2/top-headlines?sources=the-wall-street-journal&pageSize=3&apiKey=${key}`
...
const wsj = (newsdata) => {
    const articlesDiv = document.querySelector(".wsj")
