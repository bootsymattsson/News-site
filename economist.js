 url = `https://newsapi.org/v2/top-headlines?sources=the-economist&pageSize=3&apiKey=${key}`



//Ändra till nytt namn på recievedNews i ny kod
const economist = (newsdata) => {
    const articlesDiv = document.querySelector(".economist")
    ...
    newsdata.articles.forEach((article, index) => {
      ...
      div.className = "economist_artiklar"
