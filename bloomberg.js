 url = `https://newsapi.org/v2/top-headlines?sources=bloomberg&pageSize=3&apiKey=${key}`



//Ändra till nytt namn på recievedNews i ny kod
const bloomberg = (newsdata) => {
    const articlesDiv = document.querySelector(".bloomberg")
    ...
    newsdata.articles.forEach((article, index) => {
      ...
      div.className = "bloomberg_artiklar"
