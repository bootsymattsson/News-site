 url = `https://newsapi.org/v2/top-headlines?sources=business-insider&pageSize=3&apiKey=${key}`



//Ändra till nytt namn på recievedNews i ny kod
const businessinsider = (newsdata) => {
    const articlesDiv = document.querySelector(".businessinsider")
    ...
    newsdata.articles.forEach((article, index) => {
      ...
      div.className = "businessinsider_artiklar"
